//创建画面开机视频的命令索引ID
#define  _SCREEN_开机视频                                                          0

//创建画面主界面的命令索引ID
#define  _SCREEN_主界面                                                           1

//创建画面设置界面的命令索引ID
#define  _SCREEN_设置界面                                                          2

//创建画面模拟串口助手界面的命令索引ID
#define  _SCREEN_模拟串口助手界面                                                      3

//创建画面包上下线管理界面的命令索引ID
#define  _SCREEN_包上下线管理界面                                                      4

//创建画面点型仓探上下线管理CCC的命令索引ID
#define  _SCREEN_点型仓探上下线管理CCC                                                  5

//创建画面设备管理Plus的命令索引ID
#define  _SCREEN_设备管理PLUS                                                      6

//创建画面探测器状态显示的命令索引ID
#define  _SCREEN_探测器状态显示                                                       7

//创建画面菜单选择页面的命令索引ID
#define  _SCREEN_菜单选择页面                                                        8

//创建画面设备状态查询PLUS的命令索引ID
#define  _SCREEN_设备状态查询PLUS                                                    9

//创建画面设备许可证界面的命令索引ID
#define  _SCREEN_设备许可证界面                                                      10

//创建画面第九簇监控界面的命令索引ID
#define  _SCREEN_第九簇监控界面                                                      11

//创建画面第十簇监控界面的命令索引ID
#define  _SCREEN_第十簇监控界面                                                      12

//创建画面第十一簇监控界面的命令索引ID
#define  _SCREEN_第十一簇监控界面                                                     13

//创建画面第十二簇监控界面的命令索引ID
#define  _SCREEN_第十二簇监控界面                                                     14

//创建画面第一柜级监控界面的命令索引ID
#define  _SCREEN_第一柜级监控界面                                                     15

//创建画面第二柜级监控界面的命令索引ID
#define  _SCREEN_第二柜级监控界面                                                     16

//创建画面设备上下线的命令索引ID
#define  _SCREEN_设备上下线                                                        17

//创建画面设备上下线舱级的命令索引ID
#define  _SCREEN_设备上下线舱级                                                      18

//创建画面系统复位弹窗的命令索引ID
#define  _SCREEN_系统复位弹窗                                                       19

//创建画面巡检弹窗的命令索引ID
#define  _SCREEN_巡检弹窗                                                         20

//创建画面手动自动切换的命令索引ID
#define  _SCREEN_手动自动切换                                                       21

//创建画面告警查询的命令索引ID
#define  _SCREEN_告警查询                                                         22

//创建画面进入设置密码的命令索引ID
#define  _SCREEN_进入设置密码                                                       23

//创建画面设置用户密码的命令索引ID
#define  _SCREEN_设置用户密码                                                       24

//创建画面设备屏蔽簇级的命令索引ID
#define  _SCREEN_设备屏蔽簇级                                                       25

//创建画面设备屏蔽舱级的命令索引ID
#define  _SCREEN_设备屏蔽舱级                                                       26

//创建画面公司信息的命令索引ID
#define  _SCREEN_公司信息                                                         27

//创建画面第十三簇监控界面的命令索引ID
#define  _SCREEN_第十三簇监控界面                                                     28

//创建画面第十四簇监控界面的命令索引ID
#define  _SCREEN_第十四簇监控界面                                                     29

//创建画面第十五簇监控界面的命令索引ID
#define  _SCREEN_第十五簇监控界面                                                     30

//创建画面第十六簇监控界面的命令索引ID
#define  _SCREEN_第十六簇监控界面                                                     31

//创建画面第十七簇监控界面的命令索引ID
#define  _SCREEN_第十七簇监控界面                                                     32

//创建画面第十八簇监控界面的命令索引ID
#define  _SCREEN_第十八簇监控界面                                                     33

//创建画面第十九簇监控界面的命令索引ID
#define  _SCREEN_第十九簇监控界面                                                     34

//创建画面第二十簇监控界面的命令索引ID
#define  _SCREEN_第二十簇监控界面                                                     35

//创建画面第三柜级监控界面的命令索引ID
#define  _SCREEN_第三柜级监控界面                                                     36

//创建画面第四柜级监控界面的命令索引ID
#define  _SCREEN_第四柜级监控界面                                                     37

//创建画面清除报警记录的命令索引ID
#define  _SCREEN_清除报警记录                                                       38

//创建画面设备管理的命令索引ID
#define  _SCREEN_设备管理                                                         39

//创建画面喷放逻辑设定的命令索引ID
#define  _SCREEN_喷放逻辑设定                                                       40

//创建画面时间配置界面的命令索引ID
#define  _SCREEN_时间配置界面                                                       41

//创建画面逻辑设定选择界面的命令索引ID
#define  _SCREEN_逻辑设定选择界面                                                     42

//创建画面火警逻辑设定的命令索引ID
#define  _SCREEN_火警逻辑设定                                                       43

//创建画面喷房逻辑设定帮助界面的命令索引ID
#define  _SCREEN_喷房逻辑设定帮助界面                                                   44

//创建画面逻辑查看界面的命令索引ID
#define  _SCREEN_逻辑查看界面                                                       45

//创建画面超级管理员界面的命令索引ID
#define  _SCREEN_超级管理员界面                                                      46

//创建画面报警阈值设置界面的命令索引ID
#define  _SCREEN_报警阈值设置界面                                                     47

//创建画面报警阈值设置界面2的命令索引ID
#define  _SCREEN_报警阈值设置界面2                                                    48

//创建画面型号设定界面的命令索引ID
#define  _SCREEN_型号设定界面                                                       49

//创建画面出场日期规格设置界面的命令索引ID
#define  _SCREEN_出场日期规格设置界面                                                   50

//创建画面超管密码页的命令索引ID
#define  _SCREEN_超管密码页                                                        51

//创建画面按键巡检界面的命令索引ID
#define  _SCREEN_按键巡检界面                                                       52

//创建画面二级密码界面的命令索引ID
#define  _SCREEN_二级密码界面                                                       53

//创建画面第n簇监控界面的命令索引ID
#define  _SCREEN_第N簇监控界面                                                      54

//创建画面查询分类界面的命令索引ID
#define  _SCREEN_查询分类界面                                                       55

//创建画面报警显示界面的命令索引ID
#define  _SCREEN_报警显示界面                                                       56

//创建画面故障显示界面的命令索引ID
#define  _SCREEN_故障显示界面                                                       57

//创建画面灭火启动选择的命令索引ID
#define  _SCREEN_灭火启动选择                                                       58

//创建画面状态监测界面的命令索引ID
#define  _SCREEN_状态监测界面                                                       59

//创建画面监控选择界面的命令索引ID
#define  _SCREEN_监控选择界面                                                       60

//创建画面PACK监测界面的命令索引ID
#define  _SCREEN_PACK监测界面                                                     61

//创建画面PACK显示界面的命令索引ID
#define  _SCREEN_PACK显示界面                                                     62

//创建画面CABIN监测界面的命令索引ID
#define  _SCREEN_CABIN监测界面                                                    63

//创建画面CABIN显示界面的命令索引ID
#define  _SCREEN_CABIN显示界面                                                    64

//创建画面仓包上下线管理界面的命令索引ID
#define  _SCREEN_仓包上下线管理界面                                                    65

//创建画面设备上线管理点型仓的命令索引ID
#define  _SCREEN_设备上线管理点型仓                                                    66

//创建画面仓复合监测界面的命令索引ID
#define  _SCREEN_仓复合监测界面                                                      67

//创建画面新菜单界面的命令索引ID
#define  _SCREEN_新菜单界面                                                        68

//创建画面设备显示详情的命令索引ID
#define  _SCREEN_设备显示详情                                                       69

//创建画面设备屏蔽界面的命令索引ID
#define  _SCREEN_设备屏蔽界面                                                       70

//创建画面6路多线控制的命令索引ID
#define  _SCREEN_6路多线控制                                                       71
...
#define  _TXT_DIS__主界面_TEXT_DISPLAY12                                         22

#define  _BTN_主界面_BUTTON1                                                      1

#define  _TXT_DIS__主界面_TEXT_DISPLAY2                                           5

#define  _TXT_DIS__主界面_TEXT_DISPLAY3                                           6

#define  _TXT_DIS__主界面_TEXT_DISPLAY4                                           7

#define  _TXT_DIS__主界面_TEXT_DISPLAY5                                           8

#define  _TXT_DIS__主界面_TEXT_DISPLAY6                                           9

#define  _TXT_DIS__主界面_TEXT_DISPLAY7                                          11

#define  _BTN_主界面_BUTTON4                                                     10

#define  _TXT_DIS__主界面_TEXT_DISPLAY9                                          25

#define  _TXT_DIS__主界面_TEXT_DISPLAY10                                         26

#define  _BTN_主界面_BUTTON5                                                     27

#define  _TXT_DIS__主界面_TEXT_DISPLAY11                                         30

#define  _RTC_主界面_RTC1                                                         2

#define  _TXT_DIS__主界面_TEXT_DISPLAY13                                         33

#define  _TXT_DIS__主界面_TEXT_DISPLAY14                                         34

#define  _TXT_DIS__主界面_TEXT_DISPLAY15                                         18

#define  _TXT_DIS__主界面_TEXT_DISPLAY16                                         19

#define  _TXT_DIS__主界面_TEXT_DISPLAY18                                         21

#define  _TXT_DIS__主界面_TEXT_DISPLAY19                                         23

#define  _TXT_DIS__主界面_TEXT_DISPLAY17                                         16

#define  _BTN_主界面_BUTTON7                                                     32

#define  _TXT_DIS__主界面_TEXT_DISPLAY1                                           4

#define  _TXT_DIS__主界面_TEXT_DISPLAY8                                          12

#define  _TXT_DIS__主界面_TEXT_DISPLAY47                                         28

#define  _TXT_DIS__主界面_TEXT_DISPLAY48                                         29

#define  _BTN_主界面_BUTTON2                                                     31

#define  _BTN_主界面_BUTTON6                                                     35

#define  _BTN_主界面_BUTTON8                                                     37

#define  _BTN_主界面_BUTTON9                                                     38

#define  _TXT_DIS__主界面_TEXT_DISPLAY20                                          3

#define  _TXT_DIS__主界面_TEXT_DISPLAY21                                         39

#define  _TXT_DIS__主界面_TEXT_DISPLAY22                                         40

#define  _BTN_设置界面_BUTTON1                                                     1

#define  _BTN_设置界面_BUTTON2                                                     2

#define  _BTN_设置界面_BUTTON3                                                     3

#define  _BTN_设置界面_BUTTON4                                                     4

#define  _BTN_设置界面_BUTTON5                                                     5

#define  _BTN_设置界面_BUTTON6                                                     6

#define  _BTN_设置界面_BUTTON7                                                     7

#define  _BTN_设置界面_BUTTON8                                                     8

#define  _BTN_设置界面_BUTTON9                                                     9

#define  _BTN_设置界面_BUTTON10                                                   10

#define  _BTN_设置界面_BUTTON11                                                   11

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY2                                      6

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY1                                      4

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY3                                      9

#define  _BTN_模拟串口助手界面_BUTTON2                                                10

#define  _BTN_模拟串口助手界面_BUTTON3                                                12

#define  _BTN_模拟串口助手界面_BUTTON4                                                14

#define  _BTN_模拟串口助手界面_BUTTON1                                                 7

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY4                                     15

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY5                                     16

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY6                                     17

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY7                                     18

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY8                                     19

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY9                                     20

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY10                                    21

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY11                                    22

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY12                                    23

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY13                                    24

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY14                                    25

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY16                                    27

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY15                                    26

#define  _MENU_模拟串口助手界面_MENU1                                                  8

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY17                                    28

#define  _BTN_模拟串口助手界面_BUTTON5                                                29

#define  _BTN_模拟串口助手界面_BUTTON6                                                30

#define  _BTN_模拟串口助手界面_BUTTON7                                                31

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY18                                    32

#define  _BTN_模拟串口助手界面_BUTTON8                                                33

#define  _BTN_模拟串口助手界面_BUTTON9                                                35

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY19                                    36

#define  _BTN_模拟串口助手界面_BUTTON10                                               37

#define  _TXT_DIS__模拟串口助手界面_TEXT_DISPLAY20                                    38

#define  _BTN_模拟串口助手界面_BUTTON11                                               39

#define  _BTN_包上下线管理界面_BUTTON11                                               42

#define  _BTN_包上下线管理界面_BUTTON1                                                99

#define  _BTN_包上下线管理界面_BUTTON23                                                4
...
#define  _BTN_包上下线管理界面_BUTTON36                                               45

#define  _BTN_包上下线管理界面_BUTTON37                                               55

#define  _TXT_DIS__包上下线管理界面_TEXT_DISPLAY1                                     57

#define  _BTN_包上下线管理界面_BUTTON38                                               60

#define  _MENU_包上下线管理界面_MENU1                                                 77

#define  _TXT_DIS__包上下线管理界面_TEXT_DISPLAY2                                      2
...
#define  _BTN_点型仓探上下线管理CCC_BUTTON36                                          233

#define  _BTN_点型仓探上下线管理CCC_BUTTON37                                          234

#define  _TXT_DIS__点型仓探上下线管理CCC_TEXT_DISPLAY2                                235

#define  _TXT_DIS__点型仓探上下线管理CCC_TEXT_DISPLAY1                                236

#define  _BTN_点型仓探上下线管理CCC_BUTTON11                                          238

#define  _BTN_点型仓探上下线管理CCC_BUTTON26                                          239

#define  _BTN_点型仓探上下线管理CCC_BUTTON27                                          240

#define  _BTN_设备管理PLUS_BUTTON11                                               42

#define  _BTN_设备管理PLUS_BUTTON36                                               45

#define  _BTN_设备管理PLUS_BUTTON37                                               55

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY1                                     57

#define  _BTN_设备管理PLUS_BUTTON38                                               60

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY2                                      2

#define  _BTN_设备管理PLUS_BUTTON1                                                 5

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY3                                      6

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY4                                      7

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY5                                      8

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY6                                      9

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY7                                     10

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY8                                     11

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY9                                     12

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY10                                    13

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY11                                    14

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY12                                    15

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY13                                    16

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY14                                    17

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY15                                    18

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY16                                    19

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY17                                    20

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY18                                    21

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY19                                    22

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY20                                    24

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY21                                    25

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY22                                    26

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY23                                    27

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY24                                    28

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY25                                    29

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY26                                    30

#define  _MENU_设备管理PLUS_MENU1                                                 77

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY27                                    31

#define  _BTN_设备管理PLUS_BUTTON2                                                32

#define  _TXT_DIS__设备管理PLUS_TEXT_DISPLAY28                                    33
...
#define  _BTN_探测器状态显示_BUTTON11                                               238
...
#define  _BTN_菜单选择页面_BUTTON2                                                   6

#define  _BTN_菜单选择页面_BUTTON3                                                   7

#define  _BTN_菜单选择页面_BUTTON4                                                   8

#define  _BTN_菜单选择页面_BUTTON5                                                   9

#define  _TXT_DIS__菜单选择页面_TEXT_DISPLAY47                                      28

#define  _TXT_DIS__菜单选择页面_TEXT_DISPLAY48                                      29

#define  _BTN_菜单选择页面_BUTTON6                                                   1

#define  _BTN_菜单选择页面_BUTTON7                                                   2

#define  _BTN_菜单选择页面_BUTTON8                                                   3

#define  _BTN_菜单选择页面_BUTTON9                                                   4

#define  _BTN_菜单选择页面_BUTTON11                                                 23

#define  _BTN_菜单选择页面_BUTTON12                                                 24

#define  _BTN_设备状态查询PLUS_BUTTON1                                               1

#define  _BTN_设备状态查询PLUS_BUTTON3                                               3

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY1                                    5

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY2                                    6

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY3                                    7

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY4                                    8

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY5                                    9

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY6                                   10

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY7                                   11

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY16                                  23

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY17                                  24

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY18                                  25

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY19                                  26

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY20                                  27

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY21                                  28

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY22                                  29

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY9                                   12

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY10                                  13

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY11                                  14

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY12                                  15

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY13                                  16

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY14                                  17

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY15                                  18

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY23                                  19

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY24                                  20

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY25                                  21

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY26                                  22

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY27                                  30

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY28                                  31

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY29                                  32

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY30                                  33

#define  _BTN_设备状态查询PLUS_BUTTON2                                              38

#define  _BTN_设备状态查询PLUS_BUTTON4                                              39

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY31                                  37

#define  _TXT_DIS__设备状态查询PLUS_TEXT_DISPLAY8                                   34

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY2                                       8

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY3                                       9

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY4                                      10

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY8                                      11

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY9                                      12

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY10                                     13

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY11                                     14

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY12                                     15

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY13                                     16

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY1                                       1

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY5                                       2

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY6                                       3

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY7                                       4

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY14                                      5

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY15                                      6

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY16                                      7

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY17                                     17

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY18                                     18

#define  _BTN_设备许可证界面_BUTTON1                                                 19

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY19                                     20

#define  _TXT_DIS__设备许可证界面_TEXT_DISPLAY20                                     21

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY1                                       4

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY2                                       9
...
#define  _BTN_第九簇监控界面_BUTTON1                                                 14

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY3                                      16
...
#define  _BTN_第九簇监控界面_BUTTON2                                                 26

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY5                                      28
...
#define  _BTN_第九簇监控界面_BUTTON3                                                 38

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY7                                      40
...
#define  _BTN_第九簇监控界面_BUTTON4                                                 50

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY9                                      52
...
#define  _BTN_第九簇监控界面_BUTTON5                                                 62

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY11                                     64
...
#define  _BTN_第九簇监控界面_BUTTON6                                                 74

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY13                                     76
...
#define  _BTN_第九簇监控界面_BUTTON7                                                 86

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY15                                     88
...
#define  _BTN_第九簇监控界面_BUTTON8                                                 98

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY17                                    100
...
#define  _BTN_第九簇监控界面_BUTTON9                                                110

#define  _TXT_DIS__第九簇监控界面_TEXT_DISPLAY19                                    112
...
#define  _BTN_第九簇监控界面_BUTTON10                                               122

#define  _BTN_第九簇监控界面_BUTTON14                                               137
...
#define  _BTN_第十簇监控界面_BUTTON1                                                 14

#define  _TXT_DIS__第十簇监控界面_TEXT_DISPLAY3                                      16
...
#define  _BTN_第十簇监控界面_BUTTON2                                                 26

#define  _TXT_DIS__第十簇监控界面_TEXT_DISPLAY5                                      28
...
#define  _BTN_第十簇监控界面_BUTTON3                                                 38

#define  _TXT_DIS__第十簇监控界面_TEXT_DISPLAY7                                      40
...
#define  _BTN_第十簇监控界面_BUTTON4                                                 50

#define  _TXT_DIS__第十簇监控界面_TEXT_DISPLAY9                                      52
...
#define  _BTN_第十簇监控界面_BUTTON5                                                 62

#define  _TXT_DIS__第十簇监控界面_TEXT_DISPLAY11                                     64
...
#define  _BTN_第十簇监控界面_BUTTON6                                                 74

#define  _TXT_DIS__第十簇监控界面_TEXT_DISPLAY13                                     76
...
#define  _BTN_第十簇监控界面_BUTTON7                                                 86

#define  _TXT_DIS__第十簇监控界面_TEXT_DISPLAY15                                     88
...
#define  _BTN_第十簇监控界面_BUTTON8                                                 98

#define  _TXT_DIS__第十簇监控界面_TEXT_DISPLAY17                                    100
...
#define  _BTN_第十簇监控界面_BUTTON9                                                110

#define  _TXT_DIS__第十簇监控界面_TEXT_DISPLAY19                                    112
...
#define  _BTN_第十一簇监控界面_BUTTON1                                                14

#define  _TXT_DIS__第十一簇监控界面_TEXT_DISPLAY3                                     16
...
#define  _BTN_第十一簇监控界面_BUTTON2                                                26

#define  _TXT_DIS__第十一簇监控界面_TEXT_DISPLAY5                                     28
...
#define  _BTN_第十一簇监控界面_BUTTON3                                                38

#define  _TXT_DIS__第十一簇监控界面_TEXT_DISPLAY7                                     40
...
#define  _BTN_第十一簇监控界面_BUTTON4                                                50

#define  _TXT_DIS__第十一簇监控界面_TEXT_DISPLAY9                                     52
...
#define  _BTN_第十一簇监控界面_BUTTON5                                                62

#define  _TXT_DIS__第十一簇监控界面_TEXT_DISPLAY11                                    64
...
#define  _BTN_第十一簇监控界面_BUTTON6                                                74

#define  _TXT_DIS__第十一簇监控界面_TEXT_DISPLAY13                                    76
...
#define  _BTN_第十一簇监控界面_BUTTON7                                                86

#define  _TXT_DIS__第十一簇监控界面_TEXT_DISPLAY15                                    88
...
#define  _BTN_第十一簇监控界面_BUTTON8                                                98

#define  _TXT_DIS__第十一簇监控界面_TEXT_DISPLAY17                                   100
...
#define  _BTN_第十一簇监控界面_BUTTON9                                               110

#define  _TXT_DIS__第十一簇监控界面_TEXT_DISPLAY19                                   112
...
#define  _BTN_第十二簇监控界面_BUTTON1                                                14

#define  _TXT_DIS__第十二簇监控界面_TEXT_DISPLAY3                                     16
...
#define  _BTN_第十二簇监控界面_BUTTON2                                                26

#define  _TXT_DIS__第十二簇监控界面_TEXT_DISPLAY5                                     28
...
#define  _BTN_第十二簇监控界面_BUTTON3                                                38

#define  _TXT_DIS__第十二簇监控界面_TEXT_DISPLAY7                                     40
...
#define  _BTN_第十二簇监控界面_BUTTON4                                                50

#define  _TXT_DIS__第十二簇监控界面_TEXT_DISPLAY9                                     52
...
#define  _BTN_第十二簇监控界面_BUTTON5                                                62

#define  _TXT_DIS__第十二簇监控界面_TEXT_DISPLAY11                                    64
...
#define  _BTN_第十二簇监控界面_BUTTON6                                                74

#define  _TXT_DIS__第十二簇监控界面_TEXT_DISPLAY13                                    76
...
#define  _BTN_第十二簇监控界面_BUTTON7                                                86

#define  _TXT_DIS__第十二簇监控界面_TEXT_DISPLAY15                                    88
...
#define  _BTN_第十二簇监控界面_BUTTON8                                                98

#define  _TXT_DIS__第十二簇监控界面_TEXT_DISPLAY17                                   100
...
#define  _BTN_第十二簇监控界面_BUTTON9                                               110

#define  _TXT_DIS__第十二簇监控界面_TEXT_DISPLAY19                                   112
...
#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY4                                     10

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY3                                     16

#define  _BTN_第一柜级监控界面_BUTTON4                                                56

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY2                                     20

#define  _BTN_第一柜级监控界面_BUTTON1                                                28

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY6                                     36

#define  _BTN_第一柜级监控界面_BUTTON5                                                44

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY8                                     52

#define  _BTN_第一柜级监控界面_BUTTON6                                                64

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY10                                    72

#define  _BTN_第一柜级监控界面_BUTTON7                                                80

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY12                                    88

#define  _BTN_第一柜级监控界面_BUTTON8                                                96

#define  _BTN_第一柜级监控界面_BUTTON2                                                54

#define  _BTN_第一柜级监控界面_BUTTON3                                                55

#define  _BTN_第一柜级监控界面_BUTTON9                                               113

#define  _BTN_第一柜级监控界面_BUTTON10                                              115

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY13                                   117

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY14                                   118

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY15                                    12

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY16                                    15

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY17                                   120

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY1                                     17

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY5                                     25

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY18                                    26

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY19                                    33

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY20                                    34

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY21                                    35

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY22                                    41

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY23                                   122

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY24                                   124

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY25                                   127

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY26                                   128

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY27                                   129

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY7                                     49

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY9                                     61

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY11                                    62

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY28                                    69

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY29                                    70

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY30                                    71

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY31                                    77

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY32                                    89

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY33                                    90

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY34                                    93

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY35                                    94

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY36                                    95

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY37                                   111

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY38                                   138

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY39                                   139

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY40                                   142

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY41                                   143

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY42                                   144

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY43                                   149

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY44                                   150

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY45                                   151

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY46                                   152

#define  _TXT_DIS__第一柜级监控界面_TEXT_DISPLAY47                                   153
...
#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY3                                     16

#define  _BTN_第二柜级监控界面_BUTTON4                                                56

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY2                                     20

#define  _BTN_第二柜级监控界面_BUTTON1                                                28

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY6                                     36

#define  _BTN_第二柜级监控界面_BUTTON5                                                44

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY8                                     52

#define  _BTN_第二柜级监控界面_BUTTON6                                                64

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY10                                    72

#define  _BTN_第二柜级监控界面_BUTTON7                                                80

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY12                                    88

#define  _BTN_第二柜级监控界面_BUTTON8                                                96

#define  _BTN_第二柜级监控界面_BUTTON2                                                54

#define  _BTN_第二柜级监控界面_BUTTON3                                                55

#define  _BTN_第二柜级监控界面_BUTTON11                                              148

#define  _BTN_第二柜级监控界面_BUTTON9                                               113

#define  _BTN_第二柜级监控界面_BUTTON10                                              115

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY13                                   117

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY14                                   118

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY15                                    12

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY16                                    15

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY17                                   120

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY1                                     17

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY5                                     25

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY18                                    26

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY19                                    33

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY20                                    34

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY21                                    35

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY22                                    41

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY23                                   122

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY24                                   124

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY25                                   127

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY26                                   128

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY27                                   129

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY7                                     49

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY9                                     61

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY11                                    62

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY28                                    69

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY29                                    70

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY30                                    71

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY31                                    77

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY32                                    89

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY33                                    90

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY34                                    93

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY35                                    94

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY36                                    95

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY37                                   111

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY38                                   138

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY39                                   139

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY40                                   142

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY41                                   143

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY42                                   144

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY43                                   149

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY44                                   150

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY45                                   151

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY46                                   152

#define  _TXT_DIS__第二柜级监控界面_TEXT_DISPLAY47                                   153
...
#define  _TXT_DIS__设备上下线_TEXT_DISPLAY2                                         9

#define  _TXT_DIS__设备上下线_TEXT_DISPLAY3                                        12

#define  _TXT_DIS__设备上下线_TEXT_DISPLAY4                                        15

#define  _TXT_DIS__设备上下线_TEXT_DISPLAY5                                        18

#define  _TXT_DIS__设备上下线_TEXT_DISPLAY6                                        21

#define  _TXT_DIS__设备上下线_TEXT_DISPLAY7                                        26

#define  _TXT_DIS__设备上下线_TEXT_DISPLAY8                                        29

#define  _TXT_DIS__设备上下线_TEXT_DISPLAY9                                        32

#define  _TXT_DIS__设备上下线_TEXT_DISPLAY10                                       35

#define  _TXT_DIS__设备上下线_TEXT_DISPLAY11                                       38

#define  _TXT_DIS__设备上下线_TEXT_DISPLAY12                                       41

#define  _BTN_设备上下线_BUTTON11                                                  42

#define  _BTN_设备上下线_BUTTON1                                                   43
...
#define  _BTN_设备上下线舱级_BUTTON11                                                42

#define  _BTN_设备上下线舱级_BUTTON26                                                56

#define  _BTN_设备上下线舱级_BUTTON27                                                57

#define  _BTN_系统复位弹窗_BUTTON1                                                   1

#define  _TXT_DIS__系统复位弹窗_TEXT_DISPLAY1                                        2

#define  _BTN_系统复位弹窗_BUTTON2                                                   3

#define  _BTN_系统复位弹窗_BUTTON3                                                   4

#define  _TXT_DIS__巡检弹窗_TEXT_DISPLAY1                                          2

#define  _TXT_DIS__巡检弹窗_TEXT_DISPLAY2                                          5

#define  _TXT_DIS__巡检弹窗_TEXT_DISPLAY3                                          6
...
#define  _TXT_DIS__手动自动切换_TEXT_DISPLAY1                                        2

#define  _BTN_手动自动切换_BUTTON2                                                   3

#define  _BTN_手动自动切换_BUTTON3                                                   4

#define  _BTN_告警查询_BUTTON1                                                     1

#define  _BTN_告警查询_BUTTON2                                                     2

#define  _BTN_告警查询_BUTTON3                                                     3

#define  _BTN_告警查询_BUTTON4                                                     4

#define  _BTN_告警查询_BUTTON5                                                     5

#define  _TXT_DIS__告警查询_TEXT_DISPLAY1                                          6

#define  _TXT_DIS__告警查询_TEXT_DISPLAY2                                          7

#define  _TXT_DIS__告警查询_TEXT_DISPLAY3                                          8

#define  _TXT_DIS__告警查询_TEXT_DISPLAY4                                          9

#define  _TXT_DIS__告警查询_TEXT_DISPLAY5                                         10

#define  _TXT_DIS__告警查询_TEXT_DISPLAY6                                         11

#define  _TXT_DIS__告警查询_TEXT_DISPLAY7                                         12

#define  _TXT_DIS__告警查询_TEXT_DISPLAY8                                         13

#define  _TXT_DIS__告警查询_TEXT_DISPLAY9                                         14

#define  _TXT_DIS__告警查询_TEXT_DISPLAY10                                        15

#define  _TXT_DIS__告警查询_TEXT_DISPLAY11                                        16

#define  _TXT_DIS__告警查询_TEXT_DISPLAY12                                        17

#define  _TXT_DIS__告警查询_TEXT_DISPLAY13                                        18

#define  _TXT_DIS__告警查询_TEXT_DISPLAY14                                        19

#define  _TXT_DIS__告警查询_TEXT_DISPLAY15                                        20

#define  _TXT_DIS__告警查询_TEXT_DISPLAY16                                        21

#define  _TXT_DIS__告警查询_TEXT_DISPLAY17                                        22

#define  _TXT_DIS__告警查询_TEXT_DISPLAY18                                        23

#define  _TXT_DIS__告警查询_TEXT_DISPLAY19                                        24

#define  _TXT_DIS__告警查询_TEXT_DISPLAY20                                        25

#define  _TXT_DIS__告警查询_TEXT_DISPLAY21                                        26

#define  _TXT_DIS__告警查询_TEXT_DISPLAY22                                        27

#define  _TXT_DIS__告警查询_TEXT_DISPLAY23                                        28

#define  _TXT_DIS__告警查询_TEXT_DISPLAY24                                        29

#define  _TXT_DIS__告警查询_TEXT_DISPLAY25                                        30

#define  _TXT_DIS__告警查询_TEXT_DISPLAY26                                        31

#define  _TXT_DIS__告警查询_TEXT_DISPLAY27                                        32

#define  _TXT_DIS__告警查询_TEXT_DISPLAY28                                        33

#define  _TXT_DIS__告警查询_TEXT_DISPLAY29                                        34

#define  _TXT_DIS__告警查询_TEXT_DISPLAY30                                        35

#define  _TXT_DIS__告警查询_TEXT_DISPLAY31                                        36

#define  _TXT_DIS__告警查询_TEXT_DISPLAY32                                        37

#define  _TXT_DIS__告警查询_TEXT_DISPLAY33                                        38

#define  _TXT_DIS__告警查询_TEXT_DISPLAY34                                        39

#define  _TXT_DIS__告警查询_TEXT_DISPLAY35                                        40

#define  _TXT_DIS__告警查询_TEXT_DISPLAY36                                        41

#define  _TXT_DIS__告警查询_TEXT_DISPLAY37                                        42

#define  _TXT_DIS__告警查询_TEXT_DISPLAY38                                        43

#define  _TXT_DIS__告警查询_TEXT_DISPLAY39                                        44

#define  _TXT_DIS__告警查询_TEXT_DISPLAY40                                        45

#define  _TXT_DIS__告警查询_TEXT_DISPLAY41                                        46

#define  _TXT_DIS__告警查询_TEXT_DISPLAY42                                        47

#define  _TXT_DIS__告警查询_TEXT_DISPLAY43                                        48

#define  _TXT_DIS__告警查询_TEXT_DISPLAY44                                        49

#define  _TXT_DIS__告警查询_TEXT_DISPLAY45                                        50

#define  _TXT_DIS__告警查询_TEXT_DISPLAY46                                        51

#define  _TXT_DIS__告警查询_TEXT_DISPLAY47                                        52

#define  _TXT_DIS__告警查询_TEXT_DISPLAY48                                        53

#define  _TXT_DIS__告警查询_TEXT_DISPLAY49                                        54

#define  _TXT_DIS__告警查询_TEXT_DISPLAY50                                        55

#define  _TXT_DIS__告警查询_TEXT_DISPLAY51                                        56

#define  _TXT_DIS__告警查询_TEXT_DISPLAY52                                        57

#define  _TXT_DIS__告警查询_TEXT_DISPLAY53                                        58

#define  _TXT_DIS__告警查询_TEXT_DISPLAY54                                        59

#define  _TXT_DIS__告警查询_TEXT_DISPLAY55                                        60

#define  _TXT_DIS__告警查询_TEXT_DISPLAY56                                        61

#define  _TXT_DIS__告警查询_TEXT_DISPLAY57                                        62

#define  _TXT_DIS__告警查询_TEXT_DISPLAY58                                        63

#define  _TXT_DIS__告警查询_TEXT_DISPLAY59                                        64

#define  _TXT_DIS__告警查询_TEXT_DISPLAY60                                        65

#define  _TXT_DIS__告警查询_TEXT_DISPLAY61                                        66

#define  _TXT_DIS__告警查询_TEXT_DISPLAY62                                        67

#define  _TXT_DIS__告警查询_TEXT_DISPLAY63                                        68

#define  _TXT_DIS__告警查询_TEXT_DISPLAY64                                        69

#define  _TXT_DIS__告警查询_TEXT_DISPLAY65                                        70

#define  _TXT_DIS__告警查询_TEXT_DISPLAY66                                        71

#define  _TXT_DIS__告警查询_TEXT_DISPLAY67                                        72

#define  _TXT_DIS__告警查询_TEXT_DISPLAY68                                        73

#define  _TXT_DIS__告警查询_TEXT_DISPLAY69                                        74

#define  _TXT_DIS__告警查询_TEXT_DISPLAY70                                        75

#define  _TXT_DIS__告警查询_TEXT_DISPLAY71                                        76

#define  _TXT_DIS__告警查询_TEXT_DISPLAY72                                        77

#define  _TXT_DIS__告警查询_TEXT_DISPLAY73                                        78

#define  _TXT_DIS__告警查询_TEXT_DISPLAY74                                        79

#define  _TXT_DIS__告警查询_TEXT_DISPLAY75                                        80

#define  _TXT_DIS__告警查询_TEXT_DISPLAY76                                        81

#define  _TXT_DIS__告警查询_TEXT_DISPLAY77                                        82

#define  _TXT_DIS__告警查询_TEXT_DISPLAY78                                        83

#define  _TXT_DIS__告警查询_TEXT_DISPLAY79                                        84

#define  _TXT_DIS__告警查询_TEXT_DISPLAY80                                        85

#define  _TXT_DIS__告警查询_TEXT_DISPLAY81                                        86

#define  _TXT_DIS__告警查询_TEXT_DISPLAY82                                        87

#define  _TXT_DIS__告警查询_TEXT_DISPLAY83                                        88

#define  _TXT_DIS__告警查询_TEXT_DISPLAY84                                        89

#define  _TXT_DIS__告警查询_TEXT_DISPLAY85                                        90

#define  _TXT_DIS__告警查询_TEXT_DISPLAY86                                        91

#define  _TXT_DIS__告警查询_TEXT_DISPLAY87                                        92

#define  _TXT_DIS__告警查询_TEXT_DISPLAY88                                        93

#define  _TXT_DIS__告警查询_TEXT_DISPLAY89                                        94

#define  _TXT_DIS__告警查询_TEXT_DISPLAY90                                        95

#define  _TXT_DIS__告警查询_TEXT_DISPLAY91                                        97

#define  _TXT_DIS__告警查询_TEXT_DISPLAY92                                        99

#define  _TXT_DIS__告警查询_TEXT_DISPLAY93                                       100

#define  _TXT_DIS__告警查询_TEXT_DISPLAY94                                       101

#define  _TXT_DIS__告警查询_TEXT_DISPLAY95                                       102

#define  _TXT_DIS__告警查询_TEXT_DISPLAY96                                       103

#define  _TXT_DIS__告警查询_TEXT_DISPLAY97                                       104

#define  _TXT_DIS__告警查询_TEXT_DISPLAY98                                       105

#define  _TXT_DIS__告警查询_TEXT_DISPLAY99                                       106

#define  _TXT_DIS__告警查询_TEXT_DISPLAY100                                      107

#define  _TXT_DIS__告警查询_TEXT_DISPLAY101                                      108

#define  _TXT_DIS__告警查询_TEXT_DISPLAY102                                      109

#define  _TXT_DIS__告警查询_TEXT_DISPLAY103                                      117

#define  _TXT_DIS__告警查询_TEXT_DISPLAY104                                      118

#define  _TXT_DIS__告警查询_TEXT_DISPLAY105                                      119

#define  _TXT_DIS__告警查询_TEXT_DISPLAY106                                      120

#define  _TXT_DIS__告警查询_TEXT_DISPLAY107                                      121

#define  _TXT_DIS__告警查询_TEXT_DISPLAY108                                      122

#define  _TXT_DIS__告警查询_TEXT_DISPLAY109                                      123

#define  _TXT_DIS__告警查询_TEXT_DISPLAY110                                      124

#define  _TXT_DIS__告警查询_TEXT_DISPLAY111                                      125

#define  _TXT_DIS__告警查询_TEXT_DISPLAY112                                      126

#define  _BTN_告警查询_BUTTON6                                                   127

#define  _BTN_进入设置密码_BUTTON1                                                   1

#define  _TXT_DIS__进入设置密码_TEXT_DISPLAY1                                        2

#define  _BTN_进入设置密码_BUTTON2                                                   3

#define  _BTN_进入设置密码_BUTTON3                                                   4

#define  _BTN_设置用户密码_BUTTON1                                                   1

#define  _BTN_设置用户密码_BUTTON2                                                   3

#define  _BTN_设置用户密码_BUTTON3                                                   4

#define  _TXT_DIS__设置用户密码_TEXT_DISPLAY1                                        2

#define  _TXT_DIS__设置用户密码_TEXT_DISPLAY2                                        5

#define  _TXT_DIS__设置用户密码_TEXT_DISPLAY3                                        6

#define  _TXT_DIS__设置用户密码_TEXT_DISPLAY4                                        7

#define  _BTN_设备屏蔽簇级_BUTTON11                                                 42

#define  _BTN_设备屏蔽簇级_BUTTON1                                                  43

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY1                                        6

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY2                                        9

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY3                                       12

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY4                                       15

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY5                                       18

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY6                                       21

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY7                                       26

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY8                                       29

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY9                                       32

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY10                                      35

#define  _TXT_DIS__设备屏蔽簇级_TEXT_DISPLAY11                                      38
...
#define  _BTN_公司信息_BUTTON1                                                     1

#define  _TXT_DIS__公司信息_TEXT_DISPLAY1                                          2

#define  _TXT_DIS__公司信息_TEXT_DISPLAY2                                          3

#define  _TXT_DIS__公司信息_TEXT_DISPLAY3                                          4

#define  _TXT_DIS__公司信息_TEXT_DISPLAY4                                          5

#define  _BTN_公司信息_BUTTON3                                                     8

#define  _TXT_DIS__公司信息_TEXT_DISPLAY5                                          6

#define  _TXT_DIS__公司信息_TEXT_DISPLAY6                                          7

#define  _TXT_DIS__公司信息_TEXT_DISPLAY7                                          9
...
#define  _TXT_DIS__第十三簇监控界面_TEXT_DISPLAY1                                      4
...
#define  _BTN_第十三簇监控界面_BUTTON1                                                14

#define  _TXT_DIS__第十三簇监控界面_TEXT_DISPLAY3                                     16
...
#define  _BTN_第十三簇监控界面_BUTTON2                                                26

#define  _TXT_DIS__第十三簇监控界面_TEXT_DISPLAY5                                     28
...
#define  _BTN_第十三簇监控界面_BUTTON3                                                38

#define  _TXT_DIS__第十三簇监控界面_TEXT_DISPLAY7                                     40
...
#define  _BTN_第十三簇监控界面_BUTTON4                                                50

#define  _TXT_DIS__第十三簇监控界面_TEXT_DISPLAY9                                     52
...
#define  _BTN_第十三簇监控界面_BUTTON5                                                62

#define  _TXT_DIS__第十三簇监控界面_TEXT_DISPLAY11                                    64
...
#define  _BTN_第十三簇监控界面_BUTTON6                                                74

#define  _TXT_DIS__第十三簇监控界面_TEXT_DISPLAY13                                    76
...
#define  _BTN_第十三簇监控界面_BUTTON7                                                86

#define  _TXT_DIS__第十三簇监控界面_TEXT_DISPLAY15                                    88
...
#define  _BTN_第十三簇监控界面_BUTTON8                                                98

#define  _TXT_DIS__第十三簇监控界面_TEXT_DISPLAY17                                   100
...
#define  _BTN_第十三簇监控界面_BUTTON9                                               110

#define  _TXT_DIS__第十三簇监控界面_TEXT_DISPLAY19                                   112
...
#define  _TXT_DIS__第十四簇监控界面_TEXT_DISPLAY1                                      4
...
#define  _BTN_第十四簇监控界面_BUTTON1                                                14

#define  _TXT_DIS__第十四簇监控界面_TEXT_DISPLAY3                                     16
...
#define  _BTN_第十四簇监控界面_BUTTON2                                                26

#define  _TXT_DIS__第十四簇监控界面_TEXT_DISPLAY5                                     28
...
#define  _BTN_第十四簇监控界面_BUTTON3                                                38

#define  _TXT_DIS__第十四簇监控界面_TEXT_DISPLAY7                                     40
...
#define  _BTN_第十四簇监控界面_BUTTON4                                                50

#define  _TXT_DIS__第十四簇监控界面_TEXT_DISPLAY9                                     52
...
#define  _BTN_第十四簇监控界面_BUTTON5                                                62

#define  _TXT_DIS__第十四簇监控界面_TEXT_DISPLAY11                                    64
...
#define  _BTN_第十四簇监控界面_BUTTON6                                                74

#define  _TXT_DIS__第十四簇监控界面_TEXT_DISPLAY13                                    76
...
#define  _BTN_第十四簇监控界面_BUTTON7                                                86

#define  _TXT_DIS__第十四簇监控界面_TEXT_DISPLAY15                                    88
...
#define  _BTN_第十四簇监控界面_BUTTON8                                                98

#define  _TXT_DIS__第十四簇监控界面_TEXT_DISPLAY17                                   100
...
#define  _BTN_第十四簇监控界面_BUTTON9                                               110

#define  _TXT_DIS__第十四簇监控界面_TEXT_DISPLAY19                                   112
...
#define  _TXT_DIS__第十五簇监控界面_TEXT_DISPLAY1                                      4
...
#define  _BTN_第十五簇监控界面_BUTTON1                                                14

#define  _TXT_DIS__第十五簇监控界面_TEXT_DISPLAY3                                     16
...
#define  _BTN_第十五簇监控界面_BUTTON2                                                26

#define  _TXT_DIS__第十五簇监控界面_TEXT_DISPLAY5                                     28
...
#define  _BTN_第十五簇监控界面_BUTTON3                                                38

#define  _TXT_DIS__第十五簇监控界面_TEXT_DISPLAY7                                     40
...
#define  _BTN_第十五簇监控界面_BUTTON4                                                50

#define  _TXT_DIS__第十五簇监控界面_TEXT_DISPLAY9                                     52
...
#define  _BTN_第十五簇监控界面_BUTTON5                                                62

#define  _TXT_DIS__第十五簇监控界面_TEXT_DISPLAY11                                    64
...
#define  _BTN_第十五簇监控界面_BUTTON6                                                74

#define  _TXT_DIS__第十五簇监控界面_TEXT_DISPLAY13                                    76
...
#define  _BTN_第十五簇监控界面_BUTTON7                                                86

#define  _TXT_DIS__第十五簇监控界面_TEXT_DISPLAY15                                    88
...
#define  _BTN_第十五簇监控界面_BUTTON8                                                98

#define  _TXT_DIS__第十五簇监控界面_TEXT_DISPLAY17                                   100
...
#define  _BTN_第十五簇监控界面_BUTTON9                                               110

#define  _TXT_DIS__第十五簇监控界面_TEXT_DISPLAY19                                   112
...
#define  _TXT_DIS__第十六簇监控界面_TEXT_DISPLAY1                                      4
...
#define  _BTN_第十六簇监控界面_BUTTON1                                                14

#define  _TXT_DIS__第十六簇监控界面_TEXT_DISPLAY3                                     16
...
#define  _BTN_第十六簇监控界面_BUTTON2                                                26

#define  _TXT_DIS__第十六簇监控界面_TEXT_DISPLAY5                                     28
...
#define  _BTN_第十六簇监控界面_BUTTON3                                                38

#define  _TXT_DIS__第十六簇监控界面_TEXT_DISPLAY7                                     40
...
#define  _BTN_第十六簇监控界面_BUTTON4                                                50

#define  _TXT_DIS__第十六簇监控界面_TEXT_DISPLAY9                                     52
...
#define  _BTN_第十六簇监控界面_BUTTON5                                                62

#define  _TXT_DIS__第十六簇监控界面_TEXT_DISPLAY11                                    64
...
#define  _BTN_第十六簇监控界面_BUTTON6                                                74

#define  _TXT_DIS__第十六簇监控界面_TEXT_DISPLAY13                                    76
...
#define  _BTN_第十六簇监控界面_BUTTON7                                                86

#define  _TXT_DIS__第十六簇监控界面_TEXT_DISPLAY15                                    88
...
#define  _BTN_第十六簇监控界面_BUTTON8                                                98

#define  _TXT_DIS__第十六簇监控界面_TEXT_DISPLAY17                                   100
...
#define  _BTN_第十六簇监控界面_BUTTON9                                               110

#define  _TXT_DIS__第十六簇监控界面_TEXT_DISPLAY19                                   112
...
#define  _TXT_DIS__第十七簇监控界面_TEXT_DISPLAY1                                      4
...
#define  _BTN_第十七簇监控界面_BUTTON1                                                14

#define  _TXT_DIS__第十七簇监控界面_TEXT_DISPLAY3                                     16
...
#define  _BTN_第十七簇监控界面_BUTTON2                                                26

#define  _TXT_DIS__第十七簇监控界面_TEXT_DISPLAY5                                     28
...
#define  _BTN_第十七簇监控界面_BUTTON3                                                38

#define  _TXT_DIS__第十七簇监控界面_TEXT_DISPLAY7                                     40
...
#define  _BTN_第十七簇监控界面_BUTTON4                                                50

#define  _TXT_DIS__第十七簇监控界面_TEXT_DISPLAY9                                     52
...
#define  _BTN_第十七簇监控界面_BUTTON5                                                62

#define  _TXT_DIS__第十七簇监控界面_TEXT_DISPLAY11                                    64
...
#define  _BTN_第十七簇监控界面_BUTTON6                                                74

#define  _TXT_DIS__第十七簇监控界面_TEXT_DISPLAY13                                    76
...
#define  _BTN_第十七簇监控界面_BUTTON7                                                86

#define  _TXT_DIS__第十七簇监控界面_TEXT_DISPLAY15                                    88
...
#define  _BTN_第十七簇监控界面_BUTTON8                                                98

#define  _TXT_DIS__第十七簇监控界面_TEXT_DISPLAY17                                   100
...
#define  _BTN_第十七簇监控界面_BUTTON9                                               110

#define  _TXT_DIS__第十七簇监控界面_TEXT_DISPLAY19                                   112
...
#define  _TXT_DIS__第十八簇监控界面_TEXT_DISPLAY1                                      4
...
#define  _BTN_第十八簇监控界面_BUTTON1                                                14

#define  _TXT_DIS__第十八簇监控界面_TEXT_DISPLAY3                                     16
...
#define  _BTN_第十八簇监控界面_BUTTON2                                                26

#define  _TXT_DIS__第十八簇监控界面_TEXT_DISPLAY5                                     28
...
#define  _BTN_第十八簇监控界面_BUTTON3                                                38

#define  _TXT_DIS__第十八簇监控界面_TEXT_DISPLAY7                                     40
...
#define  _BTN_第十八簇监控界面_BUTTON4                                                50

#define  _TXT_DIS__第十八簇监控界面_TEXT_DISPLAY9                                     52
...
#define  _BTN_第十八簇监控界面_BUTTON5                                                62

#define  _TXT_DIS__第十八簇监控界面_TEXT_DISPLAY11                                    64
...
#define  _BTN_第十八簇监控界面_BUTTON6                                                74

#define  _TXT_DIS__第十八簇监控界面_TEXT_DISPLAY13                                    76
...
#define  _BTN_第十八簇监控界面_BUTTON7                                                86

#define  _TXT_DIS__第十八簇监控界面_TEXT_DISPLAY15                                    88
...
#define  _BTN_第十八簇监控界面_BUTTON8                                                98

#define  _TXT_DIS__第十八簇监控界面_TEXT_DISPLAY17                                   100
...
#define  _BTN_第十八簇监控界面_BUTTON9                                               110

#define  _TXT_DIS__第十八簇监控界面_TEXT_DISPLAY19                                   112
...
#define  _TXT_DIS__第十九簇监控界面_TEXT_DISPLAY1                                      4
...
#define  _BTN_第十九簇监控界面_BUTTON1                                                14

#define  _TXT_DIS__第十九簇监控界面_TEXT_DISPLAY3                                     16
...
#define  _BTN_第十九簇监控界面_BUTTON2                                                26

#define  _TXT_DIS__第十九簇监控界面_TEXT_DISPLAY5                                     28
...
#define  _BTN_第十九簇监控界面_BUTTON3                                                38

#define  _TXT_DIS__第十九簇监控界面_TEXT_DISPLAY7                                     40
...
#define  _BTN_第十九簇监控界面_BUTTON4                                                50

#define  _TXT_DIS__第十九簇监控界面_TEXT_DISPLAY9                                     52
...
#define  _BTN_第十九簇监控界面_BUTTON5                                                62

#define  _TXT_DIS__第十九簇监控界面_TEXT_DISPLAY11                                    64
...
#define  _BTN_第十九簇监控界面_BUTTON6                                                74

#define  _TXT_DIS__第十九簇监控界面_TEXT_DISPLAY13                                    76
...
#define  _BTN_第十九簇监控界面_BUTTON7                                                86

#define  _TXT_DIS__第十九簇监控界面_TEXT_DISPLAY15                                    88
...
#define  _BTN_第十九簇监控界面_BUTTON8                                                98

#define  _TXT_DIS__第十九簇监控界面_TEXT_DISPLAY17                                   100
...
#define  _BTN_第十九簇监控界面_BUTTON9                                               110

#define  _TXT_DIS__第十九簇监控界面_TEXT_DISPLAY19                                   112
...
#define  _TXT_DIS__第二十簇监控界面_TEXT_DISPLAY1                                      4
...
#define  _BTN_第二十簇监控界面_BUTTON1                                                14

#define  _TXT_DIS__第二十簇监控界面_TEXT_DISPLAY3                                     16
...
#define  _BTN_第二十簇监控界面_BUTTON2                                                26

#define  _TXT_DIS__第二十簇监控界面_TEXT_DISPLAY5                                     28
...
#define  _BTN_第二十簇监控界面_BUTTON3                                                38

#define  _TXT_DIS__第二十簇监控界面_TEXT_DISPLAY7                                     40
...
#define  _BTN_第二十簇监控界面_BUTTON4                                                50

#define  _TXT_DIS__第二十簇监控界面_TEXT_DISPLAY9                                     52
...
#define  _BTN_第二十簇监控界面_BUTTON5                                                62

#define  _TXT_DIS__第二十簇监控界面_TEXT_DISPLAY11                                    64
...
#define  _BTN_第二十簇监控界面_BUTTON6                                                74

#define  _TXT_DIS__第二十簇监控界面_TEXT_DISPLAY13                                    76
...
#define  _BTN_第二十簇监控界面_BUTTON7                                                86

#define  _TXT_DIS__第二十簇监控界面_TEXT_DISPLAY15                                    88
...
#define  _BTN_第二十簇监控界面_BUTTON8                                                98

#define  _TXT_DIS__第二十簇监控界面_TEXT_DISPLAY17                                   100
...
#define  _BTN_第二十簇监控界面_BUTTON9                                               110

#define  _TXT_DIS__第二十簇监控界面_TEXT_DISPLAY19                                   112
...
#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY3                                     16

#define  _BTN_第三柜级监控界面_BUTTON4                                                56

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY2                                     20

#define  _BTN_第三柜级监控界面_BUTTON1                                                28

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY6                                     36

#define  _BTN_第三柜级监控界面_BUTTON5                                                44

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY8                                     52

#define  _BTN_第三柜级监控界面_BUTTON6                                                64

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY10                                    72

#define  _BTN_第三柜级监控界面_BUTTON7                                                80

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY12                                    88

#define  _BTN_第三柜级监控界面_BUTTON8                                                96

#define  _BTN_第三柜级监控界面_BUTTON2                                                54

#define  _BTN_第三柜级监控界面_BUTTON3                                                55

#define  _BTN_第三柜级监控界面_BUTTON11                                              148

#define  _BTN_第三柜级监控界面_BUTTON9                                               113

#define  _BTN_第三柜级监控界面_BUTTON10                                              115

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY13                                   117

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY14                                   118

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY15                                    12

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY16                                    15

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY17                                   120

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY1                                     17

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY5                                     25

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY18                                    26

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY19                                    33

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY20                                    34

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY21                                    35

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY22                                    41

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY23                                   122

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY24                                   124

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY25                                   127

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY26                                   128

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY27                                   129

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY7                                     49

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY9                                     61

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY11                                    62

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY28                                    69

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY29                                    70

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY30                                    71

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY31                                    77

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY32                                    89

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY33                                    90

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY34                                    93

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY35                                    94

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY36                                    95

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY37                                   111

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY38                                   138

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY39                                   139

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY40                                   142

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY41                                   143

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY42                                   144

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY43                                   149

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY44                                   150

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY45                                   151

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY46                                   152

#define  _TXT_DIS__第三柜级监控界面_TEXT_DISPLAY47                                   153
...
#define  _BTN_第四柜级监控界面_BUTTON3                                                55

#define  _BTN_第四柜级监控界面_BUTTON11                                              148

#define  _BTN_第四柜级监控界面_BUTTON9                                               113

#define  _BTN_第四柜级监控界面_BUTTON10                                              115

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY4                                     10

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY3                                     16

#define  _BTN_第四柜级监控界面_BUTTON4                                                56

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY2                                     20

#define  _BTN_第四柜级监控界面_BUTTON1                                                28

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY6                                     36

#define  _BTN_第四柜级监控界面_BUTTON5                                                44

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY8                                     52

#define  _BTN_第四柜级监控界面_BUTTON6                                                64

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY10                                    72

#define  _BTN_第四柜级监控界面_BUTTON7                                                80

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY12                                    88

#define  _BTN_第四柜级监控界面_BUTTON8                                                96

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY13                                   117

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY14                                   118

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY15                                    12

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY16                                    15

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY17                                   120

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY1                                     17

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY5                                     25

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY18                                    26

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY19                                    33

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY20                                    34

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY21                                    35

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY22                                    41

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY23                                   122

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY24                                   124

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY25                                   127

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY26                                   128

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY27                                   129

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY7                                     49

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY9                                     61

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY11                                    62

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY28                                    69

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY29                                    70

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY30                                    71

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY31                                    77

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY32                                    89

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY33                                    90

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY34                                    93

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY35                                    94

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY36                                    95

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY37                                   111

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY38                                   138

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY39                                   139

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY40                                   142

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY41                                   143

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY42                                   144

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY43                                   149

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY44                                   150

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY45                                   151

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY46                                   152

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY47                                   153

#define  _TXT_DIS__第四柜级监控界面_TEXT_DISPLAY48                                   154

#define  _BTN_清除报警记录_BUTTON1                                                   1

#define  _TXT_DIS__清除报警记录_TEXT_DISPLAY1                                        2

#define  _BTN_清除报警记录_BUTTON2                                                   3

#define  _BTN_清除报警记录_BUTTON3                                                   4
...
#define  _BTN_设备管理_BUTTON13                                                   25

#define  _TXT_DIS__设备管理_TEXT_DISPLAY1                                         26

#define  _TXT_DIS__设备管理_TEXT_DISPLAY2                                         27

#define  _TXT_DIS__设备管理_TEXT_DISPLAY3                                         28

#define  _TXT_DIS__设备管理_TEXT_DISPLAY4                                         29

#define  _TXT_DIS__设备管理_TEXT_DISPLAY5                                         30

#define  _TXT_DIS__设备管理_TEXT_DISPLAY6                                         31

#define  _TXT_DIS__设备管理_TEXT_DISPLAY7                                         32

#define  _TXT_DIS__设备管理_TEXT_DISPLAY8                                         33

#define  _TXT_DIS__设备管理_TEXT_DISPLAY9                                         34

#define  _TXT_DIS__设备管理_TEXT_DISPLAY10                                        56

#define  _TXT_DIS__设备管理_TEXT_DISPLAY11                                        57

#define  _TXT_DIS__设备管理_TEXT_DISPLAY12                                        58

#define  _TXT_DIS__设备管理_TEXT_DISPLAY13                                        59

#define  _TXT_DIS__设备管理_TEXT_DISPLAY14                                        60

#define  _TXT_DIS__设备管理_TEXT_DISPLAY15                                        61

#define  _TXT_DIS__设备管理_TEXT_DISPLAY16                                        62

#define  _TXT_DIS__设备管理_TEXT_DISPLAY17                                        63

#define  _TXT_DIS__设备管理_TEXT_DISPLAY18                                        64

#define  _TXT_DIS__设备管理_TEXT_DISPLAY19                                        65

#define  _TXT_DIS__设备管理_TEXT_DISPLAY20                                        66

#define  _TXT_DIS__设备管理_TEXT_DISPLAY21                                        67

#define  _TXT_DIS__设备管理_TEXT_DISPLAY22                                        68

#define  _TXT_DIS__设备管理_TEXT_DISPLAY23                                        69

#define  _TXT_DIS__设备管理_TEXT_DISPLAY24                                        70

#define  _TXT_DIS__设备管理_TEXT_DISPLAY25                                        71

#define  _TXT_DIS__设备管理_TEXT_DISPLAY26                                        72
...
#define  _BTN_喷放逻辑设定_BUTTON2                                                   6

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY1                                        8

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY2                                        9

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY3                                       10

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY4                                       11

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY5                                       12

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY6                                       13

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY7                                       14

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY8                                       15

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY9                                       16

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY10                                      17

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY11                                      18

#define  _BTN_喷放逻辑设定_BUTTON3                                                  21

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY12                                      23

#define  _MENU_喷放逻辑设定_MENU2                                                   22

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY13                                      24

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY14                                      25

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY15                                      26

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY16                                      27

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY17                                      28

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY18                                      29

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY19                                      30

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY20                                      31

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY21                                      32

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY22                                      33

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY23                                      20

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY24                                      34

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY25                                      35

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY26                                      36

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY27                                      37

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY28                                      39

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY29                                      40

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY30                                      44

#define  _BTN_喷放逻辑设定_BUTTON4                                                  46

#define  _BTN_喷放逻辑设定_BUTTON5                                                  47

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY31                                      45

#define  _MENU_喷放逻辑设定_MENU3                                                   48

#define  _MENU_喷放逻辑设定_MENU4                                                   49

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY32                                      53

#define  _BTN_喷放逻辑设定_BUTTON6                                                  54
...
#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY33                                      58

#define  _BTN_喷放逻辑设定_BUTTON8                                                  60

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY34                                      59

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY35                                      62

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY36                                      64

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY37                                      65

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY38                                      66

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY39                                      67

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY40                                      68

#define  _MENU_喷放逻辑设定_MENU1                                                    7

#define  _MENU_喷放逻辑设定_MENU6                                                   61

#define  _TXT_DIS__喷放逻辑设定_TEXT_DISPLAY41                                      70

#define  _BTN_时间配置界面_BUTTON1                                                   1

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY1                                        9

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY2                                       10

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY3                                       11

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY4                                       12

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY5                                       13

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY6                                       14

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY7                                       16

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY8                                       17

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY9                                       18

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY10                                      19

#define  _TXT_DIS__时间配置界面_TEXT_DISPLAY11                                      20
...
#define  _BTN_逻辑设定选择界面_BUTTON2                                                 4

#define  _BTN_逻辑设定选择界面_BUTTON3                                                 5

#define  _BTN_火警逻辑设定_BUTTON1                                                  98

#define  _BTN_火警逻辑设定_BUTTON2                                                  72

#define  _TXT_DIS__火警逻辑设定_TEXT_DISPLAY1                                       73

#define  _BTN_火警逻辑设定_BUTTON3                                                   1

#define  _BTN_火警逻辑设定_BUTTON4                                                   2

#define  _BTN_火警逻辑设定_BUTTON5                                                   4

#define  _BTN_火警逻辑设定_BUTTON6                                                   5

#define  _BTN_火警逻辑设定_BUTTON7                                                   3

#define  _BTN_火警逻辑设定_BUTTON8                                                   6

#define  _BTN_火警逻辑设定_BUTTON9                                                   7

#define  _BTN_火警逻辑设定_BUTTON10                                                  8

#define  _BTN_火警逻辑设定_BUTTON11                                                  9

#define  _BTN_火警逻辑设定_BUTTON12                                                 10

#define  _BTN_火警逻辑设定_BUTTON13                                                 11

#define  _BTN_火警逻辑设定_BUTTON14                                                 12

#define  _BTN_火警逻辑设定_BUTTON15                                                 13

#define  _BTN_火警逻辑设定_BUTTON16                                                 14

#define  _BTN_火警逻辑设定_BUTTON17                                                 15

#define  _BTN_火警逻辑设定_BUTTON18                                                 16

#define  _BTN_火警逻辑设定_BUTTON19                                                 18

#define  _BTN_火警逻辑设定_BUTTON21                                                 20

#define  _BTN_火警逻辑设定_BUTTON22                                                 21
...
#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY1                                        1

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY2                                        2

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY3                                        3

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY4                                        4

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY5                                        5

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY6                                        6

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY7                                        7

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY8                                        8

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY9                                        9

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY10                                      10

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY11                                      11

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY12                                      12

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY13                                      13

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY14                                      14

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY15                                      15

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY16                                      16

#define  _TXT_DIS__逻辑查看界面_TEXT_DISPLAY17                                      17
...
#define  _BTN_超级管理员界面_BUTTON2                                                  2

#define  _BTN_超级管理员界面_BUTTON6                                                  6

#define  _TXT_DIS__超级管理员界面_TEXT_DISPLAY1                                       7

#define  _BTN_超级管理员界面_BUTTON3                                                  3

#define  _BTN_超级管理员界面_BUTTON4                                                  4

#define  _BTN_超级管理员界面_BUTTON5                                                  5

#define  _BTN_超级管理员界面_BUTTON7                                                  8

#define  _BTN_报警阈值设置界面_BUTTON1                                                 1

#define  _BTN_报警阈值设置界面_BUTTON2                                                 2

#define  _BTN_报警阈值设置界面_BUTTON3                                                 3

#define  _BTN_报警阈值设置界面_BUTTON4                                                 4

#define  _BTN_报警阈值设置界面_BUTTON7                                                 7

#define  _BTN_报警阈值设置界面_BUTTON10                                               10

#define  _BTN_报警阈值设置界面_BUTTON13                                               13

#define  _TXT_DIS__报警阈值设置界面_TEXT_DISPLAY1                                     14

#define  _TXT_DIS__报警阈值设置界面_TEXT_DISPLAY2                                     15

#define  _TXT_DIS__报警阈值设置界面_TEXT_DISPLAY3                                     16

#define  _TXT_DIS__报警阈值设置界面_TEXT_DISPLAY4                                     17

#define  _TXT_DIS__报警阈值设置界面_TEXT_DISPLAY5                                     18

#define  _TXT_DIS__报警阈值设置界面_TEXT_DISPLAY6                                     19

#define  _BTN_报警阈值设置界面2_BUTTON1                                                1

#define  _BTN_报警阈值设置界面2_BUTTON2                                                2

#define  _BTN_报警阈值设置界面2_BUTTON3                                                3

#define  _BTN_报警阈值设置界面2_BUTTON4                                                4

#define  _TXT_DIS__报警阈值设置界面2_TEXT_DISPLAY1                                     5

#define  _TXT_DIS__报警阈值设置界面2_TEXT_DISPLAY2                                     6

#define  _TXT_DIS__报警阈值设置界面2_TEXT_DISPLAY3                                     7

#define  _TXT_DIS__报警阈值设置界面2_TEXT_DISPLAY4                                     8

#define  _TXT_DIS__报警阈值设置界面2_TEXT_DISPLAY5                                     9

#define  _TXT_DIS__报警阈值设置界面2_TEXT_DISPLAY6                                    10

#define  _BTN_报警阈值设置界面2_BUTTON5                                               11
...
#define  _TXT_DIS__出场日期规格设置界面_TEXT_DISPLAY1                                   10

#define  _TXT_DIS__出场日期规格设置界面_TEXT_DISPLAY2                                   11

#define  _TXT_DIS__出场日期规格设置界面_TEXT_DISPLAY3                                   12

#define  _TXT_DIS__出场日期规格设置界面_TEXT_DISPLAY7                                   17

#define  _TXT_DIS__出场日期规格设置界面_TEXT_DISPLAY8                                   18

#define  _TXT_DIS__出场日期规格设置界面_TEXT_DISPLAY9                                   19

#define  _BTN_超管密码页_BUTTON1                                                    1

#define  _BTN_超管密码页_BUTTON2                                                    2

#define  _BTN_超管密码页_BUTTON3                                                    3
...
#define  _TXT_DIS__按键巡检界面_TEXT_DISPLAY2                                        5

#define  _TXT_DIS__按键巡检界面_TEXT_DISPLAY3                                        6

#define  _TXT_DIS__按键巡检界面_TEXT_DISPLAY4                                        7

#define  _BTN_按键巡检界面_BUTTON1                                                   1
...
#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY1                                       4

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY2                                       9

#define  _BTN_第N簇监控界面_BUTTON1                                                 14

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY3                                       1

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY4                                       2

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY5                                       7

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY6                                      11

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY7                                      13

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY8                                      18

#define  _BTN_第N簇监控界面_BUTTON2                                                 20

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY9                                      21

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY10                                     22

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY11                                     24

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY12                                     28

#define  _BTN_第N簇监控界面_BUTTON3                                                 30

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY13                                     31

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY14                                     32

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY15                                     34

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY16                                     38

#define  _BTN_第N簇监控界面_BUTTON4                                                 40

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY17                                     41

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY18                                     42

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY19                                     44

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY20                                     48

#define  _BTN_第N簇监控界面_BUTTON5                                                 50

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY21                                     51

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY22                                     52

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY23                                     54

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY24                                     58

#define  _BTN_第N簇监控界面_BUTTON6                                                 60

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY25                                     61

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY26                                     62

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY27                                     64

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY28                                     68

#define  _BTN_第N簇监控界面_BUTTON7                                                 70

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY29                                     71

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY30                                     72

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY31                                     74

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY32                                     78

#define  _BTN_第N簇监控界面_BUTTON8                                                 80

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY33                                     81

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY34                                     82

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY35                                     84

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY36                                     88

#define  _BTN_第N簇监控界面_BUTTON9                                                 90

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY37                                     91

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY38                                     92

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY39                                     94

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY40                                     98

#define  _BTN_第N簇监控界面_BUTTON10                                               100

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY41                                    101

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY42                                    102

#define  _BTN_第N簇监控界面_BUTTON15                                               104

#define  _TXT_DIS__第N簇监控界面_TEXT_DISPLAY43                                    105

#define  _BTN_第N簇监控界面_BUTTON16                                               106

#define  _BTN_第N簇监控界面_BUTTON17                                               107

#define  _BTN_第N簇监控界面_BUTTON18                                               108

#define  _MENU_第N簇监控界面_MENU1                                                 103

#define  _BTN_查询分类界面_BUTTON1                                                   1

#define  _BTN_查询分类界面_BUTTON2                                                   2

#define  _BTN_查询分类界面_BUTTON3                                                   3

#define  _BTN_查询分类界面_BUTTON4                                                   4

#define  _BTN_查询分类界面_BUTTON5                                                   5

#define  _BTN_报警显示界面_BUTTON1                                                   1

#define  _BTN_报警显示界面_BUTTON2                                                   2

#define  _BTN_报警显示界面_BUTTON3                                                   3

#define  _BTN_报警显示界面_BUTTON4                                                   4

#define  _BTN_报警显示界面_BUTTON5                                                   5

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY1                                        6

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY2                                        7

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY3                                        8

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY4                                        9

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY5                                       10

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY6                                       11

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY7                                       12

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY8                                       13

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY9                                       14

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY10                                      15

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY11                                      16

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY12                                      17

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY13                                      18

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY14                                      19

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY15                                      20

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY16                                      21

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY17                                      22

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY18                                      23

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY19                                      24

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY20                                      25

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY21                                      26

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY22                                      27

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY23                                      28

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY24                                      29

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY25                                      30

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY26                                      31

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY27                                      32

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY28                                      33

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY29                                      34

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY30                                      35

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY31                                      36

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY32                                      37

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY33                                      38

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY34                                      39

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY35                                      40

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY36                                      41

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY37                                      42

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY38                                      43

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY39                                      44

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY40                                      45

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY81                                      86

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY82                                      87

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY83                                      88

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY84                                      89

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY85                                      90

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY86                                      91

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY87                                      92

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY88                                      93

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY89                                      94

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY90                                      95

#define  _TXT_DIS__报警显示界面_TEXT_DISPLAY91                                      97
...
#define  _BTN_故障显示界面_BUTTON2                                                   2

#define  _BTN_故障显示界面_BUTTON3                                                   3

#define  _BTN_故障显示界面_BUTTON4                                                   4

#define  _BTN_故障显示界面_BUTTON5                                                   5

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY1                                        6

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY2                                        7

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY3                                        8

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY4                                        9

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY5                                       10

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY6                                       11

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY7                                       12

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY8                                       13

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY9                                       14

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY10                                      15

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY11                                      16

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY12                                      17

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY13                                      18

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY14                                      19

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY15                                      20

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY16                                      21

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY17                                      22

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY18                                      23

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY19                                      24

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY20                                      25

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY21                                      26

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY22                                      27

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY23                                      28

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY24                                      29

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY25                                      30

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY26                                      31

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY27                                      32

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY28                                      33

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY29                                      34

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY30                                      35

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY31                                      36

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY32                                      37

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY33                                      38

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY34                                      39

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY35                                      40

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY36                                      41

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY37                                      42

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY38                                      43

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY39                                      44

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY40                                      45

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY91                                      97

#define  _TXT_DIS__故障显示界面_TEXT_DISPLAY92                                      99

#define  _BTN_灭火启动选择_BUTTON1                                                  21

#define  _BTN_灭火启动选择_BUTTON2                                                  22

#define  _BTN_灭火启动选择_BUTTON3                                                  23

#define  _BTN_灭火启动选择_BUTTON4                                                  24

#define  _BTN_灭火启动选择_BUTTON5                                                  25

#define  _BTN_灭火启动选择_BUTTON6                                                  26

#define  _BTN_灭火启动选择_BUTTON7                                                  27

#define  _BTN_灭火启动选择_BUTTON8                                                  28

#define  _BTN_灭火启动选择_BUTTON9                                                  29

#define  _BTN_灭火启动选择_BUTTON10                                                 30

#define  _BTN_灭火启动选择_BUTTON11                                                 31

#define  _BTN_灭火启动选择_BUTTON12                                                 32

#define  _BTN_灭火启动选择_BUTTON13                                                 33

#define  _BTN_灭火启动选择_BUTTON14                                                 34

#define  _BTN_灭火启动选择_BUTTON15                                                 35

#define  _BTN_灭火启动选择_BUTTON16                                                 36

#define  _BTN_灭火启动选择_BUTTON17                                                 37

#define  _BTN_灭火启动选择_BUTTON18                                                 38

#define  _BTN_灭火启动选择_BUTTON19                                                 39

#define  _BTN_灭火启动选择_BUTTON20                                                 40

#define  _BTN_灭火启动选择_BUTTON21                                                 41

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY22                                      35

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY23                                      37

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY24                                      36

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY25                                      38

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY26                                      39

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY27                                      41

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY28                                      40

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY29                                      42

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY12                                      43

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY30                                      44

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY31                                      45

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY32                                      46

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY33                                      47

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY34                                      48

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY35                                      49

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY36                                      50

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY2                                       51

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY3                                       52

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY4                                       53

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY5                                       54

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY6                                       55

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY7                                        1

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY9                                        2

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY10                                       3

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY11                                       4

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY13                                       5

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY14                                       6

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY15                                       7

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY1                                        8

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY8                                        9

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY16                                      10

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY17                                      11

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY18                                      12

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY19                                      13

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY20                                      14

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY21                                      15

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY37                                      16

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY38                                      17

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY39                                      18

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY40                                      19

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY41                                      20

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY42                                      21

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY43                                      22

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY44                                      23

#define  _BTN_状态监测界面_BUTTON1                                                  24

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY45                                      25

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY46                                      26

#define  _BTN_状态监测界面_BUTTON2                                                  27

#define  _TXT_DIS__状态监测界面_TEXT_DISPLAY47                                      28
...
#define  _BTN_监控选择界面_BUTTON2                                                   6

#define  _BTN_监控选择界面_BUTTON3                                                   7

#define  _BTN_监控选择界面_BUTTON4                                                   8

#define  _BTN_监控选择界面_BUTTON5                                                   9

#define  _TXT_DIS__监控选择界面_TEXT_DISPLAY47                                      28

#define  _TXT_DIS__监控选择界面_TEXT_DISPLAY48                                      29

#define  _BTN_PACK监测界面_BUTTON15                                              104

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY43                                   105

#define  _BTN_PACK监测界面_BUTTON16                                              106

#define  _BTN_PACK监测界面_BUTTON17                                              107

#define  _BTN_PACK监测界面_BUTTON18                                              108

#define  _MENU_PACK监测界面_MENU1                                                103

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY3                                      1

#define  _BTN_PACK监测界面_BUTTON12                                              135

#define  _BTN_PACK监测界面_BUTTON11                                              143

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY1                                      3

#define  _BTN_PACK监测界面_BUTTON1                                                 5

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY2                                      7

#define  _BTN_PACK监测界面_BUTTON2                                                 9

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY4                                     11

#define  _BTN_PACK监测界面_BUTTON3                                                13

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY5                                     15

#define  _BTN_PACK监测界面_BUTTON4                                                17

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY6                                     19

#define  _BTN_PACK监测界面_BUTTON5                                                21

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY7                                     23

#define  _BTN_PACK监测界面_BUTTON6                                                25

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY8                                     27

#define  _BTN_PACK监测界面_BUTTON7                                                29

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY9                                     31

#define  _BTN_PACK监测界面_BUTTON8                                                33

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY10                                    35

#define  _BTN_PACK监测界面_BUTTON9                                                37

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY11                                    39

#define  _BTN_PACK监测界面_BUTTON10                                               41

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY12                                    43

#define  _BTN_PACK监测界面_BUTTON13                                               45

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY13                                    47

#define  _BTN_PACK监测界面_BUTTON14                                               49

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY14                                    51

#define  _BTN_PACK监测界面_BUTTON19                                               53

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY15                                    55

#define  _BTN_PACK监测界面_BUTTON20                                               57

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY16                                    59

#define  _BTN_PACK监测界面_BUTTON21                                               61

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY17                                    63

#define  _BTN_PACK监测界面_BUTTON22                                               65

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY18                                    67

#define  _BTN_PACK监测界面_BUTTON23                                               69

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY19                                    71

#define  _BTN_PACK监测界面_BUTTON24                                               73

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY20                                    75

#define  _BTN_PACK监测界面_BUTTON25                                               77

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY21                                    79

#define  _BTN_PACK监测界面_BUTTON26                                               81

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY22                                    83

#define  _BTN_PACK监测界面_BUTTON27                                               85

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY23                                    87

#define  _BTN_PACK监测界面_BUTTON28                                               89

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY24                                    91

#define  _BTN_PACK监测界面_BUTTON29                                               93

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY25                                    95

#define  _BTN_PACK监测界面_BUTTON30                                               97

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY26                                    99

#define  _BTN_PACK监测界面_BUTTON31                                              101

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY27                                   109

#define  _BTN_PACK监测界面_BUTTON32                                              111

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY28                                   113

#define  _BTN_PACK监测界面_BUTTON33                                              115

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY29                                   117

#define  _BTN_PACK监测界面_BUTTON34                                              119

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY30                                   121

#define  _BTN_PACK监测界面_BUTTON35                                              123

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY31                                   125

#define  _BTN_PACK监测界面_BUTTON36                                              127

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY32                                   129

#define  _BTN_PACK监测界面_BUTTON37                                              131

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY33                                   133

#define  _BTN_PACK监测界面_BUTTON38                                              136

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY47                                   137

#define  _TXT_DIS__PACK监测界面_TEXT_DISPLAY48                                   138

#define  _TXT_DIS__PACK显示界面_TEXT_DISPLAY11                                     5

#define  _TXT_DIS__PACK显示界面_TEXT_DISPLAY14                                     9

#define  _TXT_DIS__PACK显示界面_TEXT_DISPLAY17                                    13

#define  _TXT_DIS__PACK显示界面_TEXT_DISPLAY20                                    17

#define  _BTN_PACK显示界面_BUTTON1                                                21

#define  _BTN_CABIN监测界面_BUTTON1                                                1

#define  _BTN_CABIN监测界面_BUTTON2                                                2

#define  _BTN_CABIN监测界面_BUTTON3                                                3

#define  _BTN_CABIN监测界面_BUTTON4                                                4

#define  _BTN_CABIN监测界面_BUTTON5                                                5

#define  _BTN_CABIN监测界面_BUTTON6                                                6

#define  _BTN_CABIN监测界面_BUTTON7                                                7

#define  _BTN_CABIN监测界面_BUTTON8                                                8

#define  _BTN_CABIN监测界面_BUTTON9                                                9

#define  _BTN_CABIN监测界面_BUTTON10                                              10

#define  _BTN_CABIN监测界面_BUTTON11                                              11

#define  _BTN_CABIN监测界面_BUTTON12                                              12

#define  _BTN_CABIN监测界面_BUTTON13                                              13

#define  _BTN_CABIN监测界面_BUTTON14                                              14

#define  _BTN_CABIN监测界面_BUTTON15                                              15

#define  _BTN_CABIN监测界面_BUTTON16                                              16

#define  _BTN_CABIN监测界面_BUTTON17                                              17

#define  _BTN_CABIN监测界面_BUTTON18                                              18

#define  _BTN_CABIN监测界面_BUTTON19                                              19

#define  _BTN_CABIN监测界面_BUTTON20                                              20

#define  _BTN_CABIN监测界面_BUTTON21                                              21

#define  _BTN_CABIN监测界面_BUTTON22                                              22

#define  _BTN_CABIN监测界面_BUTTON23                                              23

#define  _BTN_CABIN监测界面_BUTTON24                                              24

#define  _BTN_CABIN监测界面_BUTTON25                                              25

#define  _BTN_CABIN监测界面_BUTTON26                                              26

#define  _BTN_CABIN显示界面_BUTTON1                                                1

#define  _TXT_DIS__CABIN显示界面_TEXT_DISPLAY1                                     2

#define  _TXT_DIS__CABIN显示界面_TEXT_DISPLAY2                                     3

#define  _TXT_DIS__CABIN显示界面_TEXT_DISPLAY3                                     4

#define  _TXT_DIS__CABIN显示界面_TEXT_DISPLAY4                                     5

#define  _TXT_DIS__CABIN显示界面_TEXT_DISPLAY5                                     6

#define  _TXT_DIS__CABIN显示界面_TEXT_DISPLAY6                                     7

#define  _TXT_DIS__CABIN显示界面_TEXT_DISPLAY7                                     8

#define  _BTN_仓包上下线管理界面_BUTTON1                                                1

#define  _BTN_仓包上下线管理界面_BUTTON2                                                2

#define  _BTN_仓包上下线管理界面_BUTTON3                                                3

#define  _BTN_仓包上下线管理界面_BUTTON4                                                4

#define  _BTN_仓包上下线管理界面_BUTTON5                                                5

#define  _BTN_仓包上下线管理界面_BUTTON6                                                6

#define  _BTN_仓包上下线管理界面_BUTTON7                                                7

#define  _BTN_仓包上下线管理界面_BUTTON8                                                8

#define  _BTN_仓包上下线管理界面_BUTTON9                                                9

#define  _BTN_仓包上下线管理界面_BUTTON10                                              10

#define  _BTN_仓包上下线管理界面_BUTTON11                                              11

#define  _BTN_仓包上下线管理界面_BUTTON12                                              12

#define  _BTN_仓包上下线管理界面_BUTTON13                                              13

#define  _BTN_仓包上下线管理界面_BUTTON14                                              14

#define  _BTN_仓包上下线管理界面_BUTTON15                                              15

#define  _BTN_仓包上下线管理界面_BUTTON16                                              16

#define  _BTN_仓包上下线管理界面_BUTTON17                                              17

#define  _BTN_仓包上下线管理界面_BUTTON18                                              18

#define  _BTN_仓包上下线管理界面_BUTTON19                                              19

#define  _BTN_仓包上下线管理界面_BUTTON20                                              20

#define  _BTN_仓包上下线管理界面_BUTTON21                                              21

#define  _BTN_仓包上下线管理界面_BUTTON22                                              22

#define  _BTN_仓包上下线管理界面_BUTTON23                                              23

#define  _BTN_仓包上下线管理界面_BUTTON24                                              24
...
#define  _BTN_设备上线管理点型仓_BUTTON11                                              42

#define  _BTN_设备上线管理点型仓_BUTTON26                                              56
...
#define  _BTN_仓复合监测界面_BUTTON1                                                  1

#define  _BTN_仓复合监测界面_BUTTON3                                                  3

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY1                                       5

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY2                                       6

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY3                                       7

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY4                                       8

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY5                                       9

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY6                                      10

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY7                                      11

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY8                                      12

#define  _BTN_仓复合监测界面_BUTTON4                                                 13

#define  _BTN_仓复合监测界面_BUTTON5                                                 14

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY9                                      15

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY10                                     16

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY11                                     17

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY12                                     18

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY13                                     19

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY14                                     20

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY15                                     21

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY16                                     23

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY17                                     24

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY18                                     25

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY19                                     26

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY20                                     27

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY21                                     28

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY22                                     29

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY23                                     30

#define  _BTN_仓复合监测界面_BUTTON6                                                 31

#define  _BTN_仓复合监测界面_BUTTON7                                                 32

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY24                                     33

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY25                                     34

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY26                                     35

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY27                                     36

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY28                                     37

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY29                                     38

#define  _TXT_DIS__仓复合监测界面_TEXT_DISPLAY30                                     39

#define  _BTN_新菜单界面_BUTTON1                                                    1

#define  _BTN_新菜单界面_BUTTON2                                                    2

#define  _BTN_新菜单界面_BUTTON3                                                    3

#define  _BTN_新菜单界面_BUTTON4                                                    4

#define  _BTN_新菜单界面_BUTTON5                                                    5

#define  _BTN_新菜单界面_BUTTON6                                                    6

#define  _BTN_新菜单界面_BUTTON7                                                    7

#define  _BTN_新菜单界面_BUTTON8                                                    8

#define  _BTN_新菜单界面_BUTTON9                                                    9

#define  _BTN_新菜单界面_BUTTON10                                                  10

#define  _BTN_新菜单界面_BUTTON11                                                  11

#define  _BTN_新菜单界面_BUTTON12                                                  12

#define  _BTN_新菜单界面_BUTTON13                                                  13

#define  _BTN_新菜单界面_BUTTON14                                                  14

#define  _BTN_新菜单界面_BUTTON15                                                  15

#define  _BTN_新菜单界面_BUTTON16                                                 200

#define  _BTN_新菜单界面_BUTTON17                                                 201
...
#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY3                                        2

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY4                                        3

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY5                                        4

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY6                                        5

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY7                                        6

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY8                                        7

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY9                                        8

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY10                                       9

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY11                                      10

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY12                                     500

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY13                                     501

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY14                                     400

#define  _BTN_设备显示详情_BUTTON1                                                 300

#define  _BTN_设备显示详情_BUTTON2                                                 301

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY15                                     502

#define  _BTN_设备显示详情_BUTTON3                                                 302

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY16                                      11

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY17                                      12

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY18                                      13

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY19                                      14

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY20                                      15

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY21                                      16

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY22                                      17

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY23                                      18

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY24                                      19

#define  _TXT_DIS__设备显示详情_TEXT_DISPLAY25                                      20

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY2                                        1

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY3                                        2

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY4                                        3

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY5                                        4

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY6                                        5

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY7                                        6

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY8                                        7

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY9                                        8

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY10                                       9

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY11                                      10

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY16                                      11

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY17                                      12

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY18                                      13

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY19                                      14

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY20                                      15

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY21                                      16

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY22                                      17

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY23                                      18

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY24                                      19

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY25                                      20

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY1                                      201

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY14                                     203

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY26                                     202

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY27                                     204

#define  _MENU_设备屏蔽界面_MENU1                                                  300

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY28                                     205

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY12                                     206

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY13                                     207

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY15                                     208

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY29                                      21

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY30                                     209

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY31                                      22

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY32                                      23

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY33                                      24

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY34                                      26

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY35                                      27

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY36                                      28

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY37                                      29

#define  _TXT_DIS__设备屏蔽界面_TEXT_DISPLAY38                                      30

#define  _BTN_设备屏蔽界面_BUTTON1                                                 210

#define  _BTN_设备屏蔽界面_BUTTON2                                                 211

#define  _BTN_设备屏蔽界面_BUTTON3                                                 212
...
#define  _TXT_DIS__新检查界面_TEXT_DISPLAY2                                       200

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY3                                       201

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY4                                       202

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY5                                       203

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY6                                       204

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY7                                       205

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY8                                       206

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY9                                       207

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY10                                        1

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY11                                        2

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY12                                        3

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY13                                        4

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY14                                      208

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY15                                      209

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY16                                      210

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY17                                      211

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY18                                        5

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY19                                        6

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY20                                        7

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY21                                        8

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY22                                      212

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY23                                        9

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY24                                      213

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY25                                       10

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY26                                      214

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY27                                       11

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY28                                      215

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY29                                       12

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY30                                      216

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY31                                       13

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY32                                      217

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY33                                       14

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY34                                      218

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY35                                       15

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY36                                      219

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY37                                       16

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY38                                      220

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY39                                       17

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY40                                      221

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY41                                       18

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY42                                      222

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY43                                       19

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY44                                      223

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY45                                       20

#define  _TXT_DIS__新检查界面_TEXT_DISPLAY46                                       21
...
#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY3                                        3

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY4                                        4

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY5                                        5

#define  _BTN_设备中文命名_BUTTON1                                                   6

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY6                                        7

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY7                                        8

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY8                                        9

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY9                                       10

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY10                                      11

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY11                                      12

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY12                                      13

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY13                                      14

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY14                                      15

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY15                                      16

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY16                                      17

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY17                                      18

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY18                                      19

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY19                                      20

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY20                                      21

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY21                                      22

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY22                                      23

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY23                                      24

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY24                                      25

#define  _TXT_DIS__设备中文命名_TEXT_DISPLAY25                                      26

#define  _BTN_设备中文命名_BUTTON2                                                  27

#define  _BTN_设备中文命名_BUTTON3                                                  28

#define  _BTN_设备中文命名_BUTTON4                                                  29
