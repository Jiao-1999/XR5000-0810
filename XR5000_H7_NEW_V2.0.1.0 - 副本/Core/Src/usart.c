...
void MX_USART1_UART_Init(void)
{
  ...
  huart1.Init.BaudRate = 19200;  /* FECbus 双串口: USART1 主机通道, 与 USART3 一致 (GB4717 附录C) */
...
void MX_USART2_UART_Init(void)
{
  ...
  huart2.Init.BaudRate = 9600; /* XR5000_LOOP2_CHANGE_20260728: match default Modbus baud rate of XR-SGBJQ/XR2200/XR1530. */
...
void MX_USART3_UART_Init(void)
{
  ...
  huart3.Init.BaudRate = 19200;  /* XR5000_FECBUS_20260811: GB4717 附录C FECbus RS485 推荐波特率 */
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    */
    ...
    /* UART9 DMA Init */
    /* UART9_RX Init */
    hdma_uart9_rx.Instance = DMA1_Stream5;
  ...
  */
    ...
    */
    ...
    /* USART1 DMA Init */
    /* USART1_RX Init */
    hdma_usart1_rx.Instance = DMA1_Stream7;
