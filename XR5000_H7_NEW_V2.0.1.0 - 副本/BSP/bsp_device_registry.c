...
#define DEVICE_REGISTRY_MAX_ADDRESS  110U /* 回路1保留101~110给FIM-1017 */
...
{
    {DEVICE_PRODUCT_XR805_V20,    "XR805-V2.0", LOOP3_MASK, DEVICE_PARSER_XR805,  19U, 50U, 0x003FU, 0U, 0U, DEVICE_CONTROL_DRIVER_NONE},
    {DEVICE_PRODUCT_XR805_EXD,    "XR805-EXD",  LOOP3_MASK, DEVICE_PARSER_XR805,  19U, 50U, 0x003FU, 0U, 0U, DEVICE_CONTROL_DRIVER_NONE},
    {DEVICE_PRODUCT_XR805_EXI,    "XR805-EXi",  LOOP3_MASK, DEVICE_PARSER_XR805,  19U, 50U, 0x003FU, 0U, 0U, DEVICE_CONTROL_DRIVER_NONE},
    {DEVICE_PRODUCT_DLYGWG,       "XR-DLYGWG",  LOOP3_MASK, DEVICE_PARSER_DLYGWG, 1U,  0U, 0U, 0U, 0U, DEVICE_CONTROL_DRIVER_NONE},
    {DEVICE_PRODUCT_XR8001_SMOKE, "JTY-XR8001", LOOP1_MASK, DEVICE_PARSER_XR8001, 1U, 23U, 0x0001U, 0U, 0U, DEVICE_CONTROL_DRIVER_NONE},
    {DEVICE_PRODUCT_XR8002_TEMP,  "JTY-XR8002", LOOP1_MASK, DEVICE_PARSER_XR8002, 1U, 31U, 0x0020U, 0U, 0U, DEVICE_CONTROL_DRIVER_NONE},
    {DEVICE_PRODUCT_XR8303,       "XR8303",     LOOP3_MASK, DEVICE_PARSER_XR8303, 19U, 50U, 0x007FU, 0U, 0U, DEVICE_CONTROL_DRIVER_NONE},
    {DEVICE_PRODUCT_XR8305,       "XR8305",     LOOP3_MASK, DEVICE_PARSER_XR8305, 19U, 50U, 0x007FU, 0U, 0U, DEVICE_CONTROL_DRIVER_NONE},
    ...
    {DEVICE_PRODUCT_SGBJQ,        "XR-SGBJQ",   LOOP2_MASK, DEVICE_PARSER_SGBJQ,   1U, 82U, 0U,
        DEVICE_CAP_STATUS_READ | DEVICE_CAP_OUTPUT_CONTROL, DEVICE_OUTPUT_1 | DEVICE_OUTPUT_2, DEVICE_CONTROL_DRIVER_SGBJQ},
    ...
    {DEVICE_PRODUCT_FIM1017,      "FIM-1017",   LOOP1_MASK, DEVICE_PARSER_FIM1017, 1U, 76U, 0U,
        DEVICE_CAP_STATUS_READ, 0U, DEVICE_CONTROL_DRIVER_NONE},
    {DEVICE_PRODUCT_FCM1011,      "FCM-1011",   LOOP2_MASK, DEVICE_PARSER_FCM1011, 3U, 74U, 0U,
        DEVICE_CAP_STATUS_READ | DEVICE_CAP_OUTPUT_CONTROL, DEVICE_OUTPUT_1, DEVICE_CONTROL_DRIVER_FCM1011},
    {DEVICE_PRODUCT_FAN_BUTTON,   "\xB7\xE7\xBB\xFA\xC6\xF4\xCD\xA3\xB0\xB4\xC5\xA5", LOOP2_MASK,
        DEVICE_PARSER_FAN_BUTTON, 1U, 61U, 0U, DEVICE_CAP_STATUS_READ, 0U, DEVICE_CONTROL_DRIVER_NONE}
};
...
} g_national_name_table[] =
{
    ...
    {50U, "复合式火灾探测器"},
    {61U, "消防电气控制装置"},
    {74U, "\xCA\xE4\xC8\xEB\xCA\xE4\xB3\xF6\xC4\xA3\xBF\xE9"},
    {82U, "声光报警器"}
};
