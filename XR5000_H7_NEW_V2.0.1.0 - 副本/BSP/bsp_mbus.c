...
uint8_t cang_polling = 1; // ��ѯ��ʼֵ��ע��Ϊ�˼�����Ļ��ʾ���±��1��ʼ��
...
void ReadPointTypeSetOnlieState(void)
{
	...
	{
		if(PointTypeMixtureOnlieState[i] > 1U)//�ж��Ƿ�Ϊ��һ��д��
		{
...
void PointTypeMixtureOnlieStateBatchSetting(uint8_t *new_online_state, uint8_t update_len)
{
	...
	PointTypeMixtureOnlieStateDeInit(); // �����״̬
...
/*
 * ����������������������������������������������������������������������������������������������������������������������������
 * ��һ�ࣺ�������� �� ����Դ PointTypeMixtureOnlieState[]
 * ���壺�û�ͨ��UI���õ�"���ø�̽��������"����ͼ
 *       1 = ����, 0 = ����
 * ע�⣺������ʵ�����ߣ�ʵ������ = �������� && DisconnectCount < MIXTURE_DEVICE_DISCONNECT_SUM
 * ����������������������������������������������������������������������������������������������������������������������������
 */
...
/*
 * ����������������������������������������������������������������������������������������������������������������������������
 * �ڶ��ࣺ�����ж� �� ����Դ PointTypeMixtureDisconnectCount[]
 * ���壺һ����ʵ����ʱ�� +1���յ��Ϸ��ظ�����
 *       >= MIXTURE_DEVICE_DISCONNECT_SUM ���ж�Ϊ����
 * ����������������������������������������������������������������������������������������������������������������������������
 */
...
{
	memset(PointTypeMixtureDisconnectCount, 0, sizeof(PointTypeMixtureDisconnectCount));//�������
}
/*
 * ����������������������������������������������������������������������������������������������������������������������������
 * �����ࣺ�������� �� ����Դ PointTypeMixtureReceiveDataTemper/Smoke[]
 * ���壺��̽�����ظ��н��������¶�ֵ������ֵ
 *       �� MBus1ReceiveSlaveDataDeal() ���յ��Ϸ��ظ�ʱ����
 * ����������������������������������������������������������������������������������������������������������������������������
 */
...
/*
 *  ����״̬ �� ����Դ PointTypeMixtureReceiveStateTemper/Smoke[]
 *  ���壺̽�����ظ��еı���״̬λ��!=0 ��ʾ���ڱ���
 */
 ...
 * ����������������������������������������������������������������������������������������������������������������������������
 * �����ࣺ̽��������
 *  DetectName �� �ͺ������� 8001_AI=1, 800C=2��
 *  DetectType �� ������ͣ�Smoke=1�̸�, Temper=2�¸У�
 * ����������������������������������������������������������������������������������������������������������������������������
 */
...
{
	memset(PointTypeMixtureAllStateMemory, 0, sizeof(PointTypeMixtureAllStateMemory));//�������
}
