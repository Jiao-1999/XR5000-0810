...
#define CAN_MONITOR_NAME_SELECT_ID   208U
...
static const uint8_t g_can_monitor_reset_item_text[CAN_MONITOR_NAME_ALL_ITEM + 1U][10] = {
    {0xB5U,0xDAU,0x20U,0x31U,0x20U,0xC2U,0xB7U,0U},
    {0xB5U,0xDAU,0x20U,0x32U,0x20U,0xC2U,0xB7U,0U},
    {0xB5U,0xDAU,0x20U,0x33U,0x20U,0xC2U,0xB7U,0U},
    {0xB5U,0xDAU,0x20U,0x34U,0x20U,0xC2U,0xB7U,0U},
    {0xB5U,0xDAU,0x20U,0x35U,0x20U,0xC2U,0xB7U,0U},
    {0xB1U,0xB8U,0xD3U,0xC3U,0xCFU,0xDFU,0xC2U,0xB7U,0U},
    {0xC8U,0xABU,0xB2U,0xBFU,0xD6U,0xD8U,0xD6U,0xC3U,0U}
};
...
void CanMonitorResetChannelName(uint8_t item)
{
    ...
    SetTextValue(CAN_MONITOR_NAME_PAGE_ID, CAN_MONITOR_NAME_SELECT_ID,
                 (uint8_t *)g_can_monitor_reset_item_text[item]);
