...
typedef enum
{
	...
	/* FIM-1017三条支路独立记录，不改变现有Flash记录结构。 */
	FIM1017_BRANCH1_SHORT = 73,
	FIM1017_BRANCH1_RECOVERY = 74,
	FIM1017_BRANCH2_SHORT = 75,
	FIM1017_BRANCH2_RECOVERY = 76,
	FIM1017_BRANCH3_SHORT = 77,
	FIM1017_BRANCH3_RECOVERY = 78,
	/* IG3302-DC: each fan and each fault source is recorded independently. */
	IG3302_FAN1_PUSHROD_FAULT = 79,
	IG3302_FAN1_PUSHROD_RECOVERY = 80,
	IG3302_FAN1_DEVICE_FAULT = 81,
	IG3302_FAN1_DEVICE_RECOVERY = 82,
	IG3302_FAN1_COMBINED_FAULT = 83,
	IG3302_FAN1_COMBINED_RECOVERY = 84,
	IG3302_FAN2_PUSHROD_FAULT = 85,
	IG3302_FAN2_PUSHROD_RECOVERY = 86,
	IG3302_FAN2_DEVICE_FAULT = 87,
	IG3302_FAN2_DEVICE_RECOVERY = 88,
	IG3302_FAN2_COMBINED_FAULT = 89,
	IG3302_FAN2_COMBINED_RECOVERY = 90,
