...
#include <string.h>
/*==============================================================
 * [GB4717] 硬件/结构类条款集中标记(非代码实现, 供审查定位到硬件负责人)
 * [GB4717 B.1.4.3] 反向电压120% 1min 试验  —— 硬件项, 非代码实现
 * [GB4717 B.1.4.5] 接口保护装置            —— 结构项, 非代码实现
 * [GB4717 B.1.1.1e] 集中型记录区域型信息   —— 不适用, 本机为区域型控制器
 * [GB4717 B.1.3.2] USB 母口连接器类型      —— 待硬件确认(见 usb_cdc.c 文件头)
 *============================================================*/
